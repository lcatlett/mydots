...
# Lando
#export PATH="/Users/lindseycatlett/.lando/bin${PATH+:$PATH}"; #landopathexport PATH="/opt/homebrew/opt/mysql@8.4/bin:$PATH"
...
# Init nvm
export NVM_DIR="$HOME/.nvm"
# NVM_STATE=$(cat /Users/lindseycatlett/.scripts/nvm.state)
# if [ $NVM_STATE = 1 ]; then
#     [ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
#     [ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion
# else
...
# if [ -f /Users/lindseycatlett/.scripts/nvm.state ]; then
#     NVM_STATE=$(cat /Users/lindseycatlett/.scripts/nvm.state)[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
